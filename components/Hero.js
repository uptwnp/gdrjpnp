...
const Hero = () => {
  ...
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent('Hi! I\'m interested in your premium properties. Please share more details.');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Find Your Dream
              <span className="text-blue-600 block">Property Today</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Discover premium residential and commercial properties with world-class amenities. 
              Get expert guidance from our real estate professionals.
            </p>
