          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Welcome to Trident Realty ("we," "our," or "us"). We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">We may share your information when you have given us explicit consent to do so.</p>

              <h3 className="text-xl font-semibold text-gray-900 mb-3">4.2 Service Providers</h3>
              <p className="text-gray-700 mb-4">We may share information with trusted third-party service providers who assist us in operating our business.</p>
            ...
            <section className="mb-8">
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4">
                <p className="text-yellow-800">
                  <strong>Important:</strong> While we strive to protect your information, we cannot guarantee absolute security of data transmitted over the internet.
                </p>
              </div>
            </section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-700">
                      <a href="mailto:privacy@tridentrealty.com" className="text-blue-600 hover:text-blue-800">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                This Privacy Policy is governed by the laws of India. Any disputes arising from this policy will be subject to the jurisdiction of the courts in Mumbai, Maharashtra.
              </p>
            </section>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
              ...
              <p className="text-blue-800">
                If you have any questions about our privacy practices or need assistance with your data rights, 
                please don't hesitate to contact our privacy team at{' '}
                <a href="mailto:privacy@tridentrealty.com" className="font-semibold underline">
                  privacy@tridentrealty.com
                </a>
              </p>
            </div>
